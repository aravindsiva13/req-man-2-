...
class _SettingsTab extends StatelessWidget {
        ...
        children: [
          ...
          _buildSettingsSection(
            ...
            children: [
              ...
              _buildSettingsTile(
                ...
                subtitle: 'SMTP and notification settings',
          ...
          _buildSettingsSection(
            ...
            children: [
              _buildSettingsTile(
                ...
                subtitle: 'Configure default permissions',
                onTap: () => _showRoleSettings(context),
              ),
              _buildSettingsTile(
                icon: Icons.lock,
          ...
          _buildSettingsSection(
            ...
            children: [
              _buildSettingsTile(
                ...
                subtitle: 'Configure automatic approvals',
                onTap: () => _showAutoApprovalSettings(context),
              ),
              _buildSettingsTile(
          ...
          _buildSettingsSection(
            ...
            children: [
              ...
              _buildInfoTile('Last Updated', '2024-01-15'),
              _buildInfoTile('Database', 'Connected'),
              _buildInfoTile('Active Users', '25'),
            ],
          ),
        ],
      ),
        ...
        content: const Column(
          ...
          children: [
            ListTile(
              ...
              subtitle: Text('Enabled - Daily at 2:00 AM'),
              trailing: Icon(Icons.check_circle, color: Colors.green),
            ),
            ListTile(
              title: Text('Last Backup'),
              subtitle: Text('2024-01-15 02:00:00'),
            ),
          ],
        ),
        actions: [
  ...
  void _showEmailSettings(BuildContext context) {
    _showComingSoonDialog(context, 'Email Configuration');
  }

  void _showRoleSettings(BuildContext context) {
    _showComingSoonDialog(context, 'Role Settings');
  }

  void _showPasswordPolicy(BuildContext context) {
    _showComingSoonDialog(context, 'Password Policy');
  }

  void _showAutoApprovalSettings(BuildContext context) {
    _showComingSoonDialog(context, 'Auto-Approval Rules');
  }
